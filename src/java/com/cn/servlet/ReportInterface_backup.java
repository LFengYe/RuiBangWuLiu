 ...
 * @author LFeng
 */
public class ReportInterface_backup extends HttpServlet {

    private static final Logger logger = Logger.getLogger(ReportInterface_backup.class);
            ...
            switch (module) {
                    ...
                    switch (operation) {
                        case "create": {
                            if (loginType.compareTo("customerLogin") == 0) {
                                json = reportOperateWithPageForSupplier(userName, operateType, "spGetSFCTotalDataWithFilter", "com.cn.bean.report.", "SFCTotalData",
                                ...
                                json = reportOperateWithPage(operateType, "spGetSFCTotalDataWithFilter", "com.cn.bean.report.", "SFCTotalData",
                                        "SupplierID", datas, pageSize, pageIndex, start, end,
                                        new ReportItemOperate() {
                                    @Override
                                    public void itemObjOperate(Object obj) {
                            ...
                            json = reportOperate(operateType, "spGetSFCTotalData", "SFCTotalData", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                                    SFCTotalData data = (SFCTotalData) obj;
                                    PartBaseInfo baseInfo = JSONObject.parseObject(RedisAPI.get("partBaseInfo_" + data.getPartCode().toLowerCase()), PartBaseInfo.class);
                ...
                case "部品计划完成情况": {
                    switch (operation) {
                        case "create": {
                            if (loginType.compareTo("customerLogin") == 0) {
                                json = reportOperateWithPageForSupplier(userName, operateType, "spGETJHCKCompletionAllInfoWithFilter", "com.cn.bean.report.", "JHCKCompletionAllInfo",
                                        "SupplierID", datas, pageSize, pageIndex, start, end,
                                        new ReportItemOperate() {
                                    @Override
                                    public void itemObjOperate(Object obj) {
                                ...
                                json = reportOperateWithPage(operateType, "spGETJHCKCompletionAllInfoWithFilter", "com.cn.bean.report.", "JHCKCompletionAllInfo",
                                        "SupplierID", datas, pageSize, pageIndex, start, end,
                                        new ReportItemOperate() {
                                    @Override
                                    public void itemObjOperate(Object obj) {
                ...
                case "部品报警明细表": {
                    switch (operation) {
                        case "create": {
                            ...
                            json = reportOperate(operateType, "spGetKCAlertListData", "KCAlertListData", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                ...
                case "待检入库报表": {
                    switch (operation) {
                        case "create": {
                            ...
                            json = reportOperate(operateType, "spGetRKListForDjpRK", "RKListForDjpRK", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                             ...
                             */
                            if (loginType.compareTo("customerLogin") == 0) {
                                json = reportOperateWithPageForSupplier(userName, operateType, "spGetRKListForDjpRKWithFilter", "com.cn.bean.report.", "RKListForDjpRK",
                                        "SupplierID", datas, pageSize, pageIndex, start, end,
                                        new ReportItemOperate() {
                                    @Override
                                    public void itemObjOperate(Object obj) {
                                ...
                                json = reportOperateWithPage(operateType, "spGetRKListForDjpRKWithFilter", "com.cn.bean.report.", "RKListForDjpRK",
                                        "SupplierID", datas, pageSize, pageIndex, start, end,
                                        new ReportItemOperate() {
                                    @Override
                                    public void itemObjOperate(Object obj) {
                        ...
                        case "request_detail": {
                            ...
                            json = reportOperateWithFilter(operateType, "spGetRKListForDjpRK", "RKListForDjpRK", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                ...
                case "送检出库报表": {
                    switch (operation) {
                        case "create": {
                            ...
                            json = reportOperate(operateType, "spGetRKListForSJCK", "RKListForSJCK", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                        ...
                        case "request_detail": {
                            ...
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetRKListForSJCK", "RKListForSJCK", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    RKListForSJCK data = (RKListForSJCK) obj;
                ...
                case "送检返回报表": {
                    switch (operation) {
                        case "create": {
                            ...
                            json = reportOperate(operateType, "spGetRKListForSJTK", "RKListForSJTK", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                        ...
                        case "request_detail": {
                            ...
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetRKListForSJTK", "RKListForSJTK", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    RKListForSJTK data = (RKListForSJTK) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0
                ...
                case "良品入库报表": {
                    switch (operation) {
                        case "create": {
                            ...
                            json = reportOperate(operateType, "spGetRKListForLpRK", "RKListForLpRK", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                            ...
                            if (loginType.compareTo("customerLogin") == 0) {
                                json = reportOperateWithPageForSupplier(userName, operateType, "spGetRKListForLpRKWithFilter", "com.cn.bean.report.", "RKListForLpRK",
                                        "SupplierID", datas, pageSize, pageIndex, start, end,
                                        new ReportItemOperate() {
                                    @Override
                                    public void itemObjOperate(Object obj) {
                                ...
                                json = reportOperateWithPage(operateType, "spGetRKListForLpRKWithFilter", "com.cn.bean.report.", "RKListForLpRK",
                                        "SupplierID", datas, pageSize, pageIndex, start, end,
                                        new ReportItemOperate() {
                                    @Override
                                    public void itemObjOperate(Object obj) {
                        ...
                        case "request_detail": {
                            ...
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetRKListForLpRK", "RKListForLpRK", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    RKListForLpRK data = (RKListForLpRK) obj;
                                    if (data.getPartCode().compareToIgnoreCase(dataJson.getString("partCode")) == 0) {
                ...
                case "不良品入库报表": {
                    switch (operation) {
                        case "create": {
                            ...
                            json = reportOperate(operateType, "spGetRKListForBLpRK", "RKListForBLpRK", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                             ...
                             */
                            if (loginType.compareTo("customerLogin") == 0) {
                                json = reportOperateWithPageForSupplier(userName, operateType, "spGetRKListForBLpRKWithFilter", "com.cn.bean.report.", "RKListForBLpRK",
                                        "SupplierID", datas, pageSize, pageIndex, start, end,
                                        new ReportItemOperate() {
                                    @Override
                                    public void itemObjOperate(Object obj) {
                                ...
                                json = reportOperateWithPage(operateType, "spGetRKListForBLpRKWithFilter", "com.cn.bean.report.", "RKListForBLpRK",
                                        "SupplierID", datas, pageSize, pageIndex, start, end,
                                        new ReportItemOperate() {
                                    @Override
                                    public void itemObjOperate(Object obj) {
                ...
                case "返修良品入库": {
                    switch (operation) {
                        ...
                        case "request_detail": {
                            ...
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetRKListForFxpRK", "RKListForFxpRK", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    RKListForFxpRK data = (RKListForFxpRK) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0
                ...
                case "良品返修出库": {
                    switch (operation) {
                        ...
                        case "request_detail": {
                            ...
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetCKListForFxpCK", "CKListForFxpCK", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    CKListForFxpCK data = (CKListForFxpCK) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0
                ...
                case "计划出库报表": {
                    switch (operation) {
                        case "create": {
                            ...
                            json = reportOperate(operateType, "spGetCKListForZCJHCK", "CKListForZCJHCK", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
...
//                                    System.out.println(data.getPartCode() + ":" + RedisAPI.get("partBaseInfo_" + data.getPartCode()));
                        ...
                        case "request_detail": {
                            JSONObject proParams = new JSONObject();
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetCKListForZCJHCK", "CKListForZCJHCK", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    CKListForZCJHCK data = (CKListForZCJHCK) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0
                ...
                case "临时调货报表": {
                    switch (operation) {
                        case "create": {
                            ...
                            json = reportOperate(operateType, "spGetCKListForLSDHCK", "CKListForZCJHCK", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                                    CKListForZCJHCK data = (CKListForZCJHCK) obj;
                                    PartBaseInfo baseInfo = JSONObject.parseObject(RedisAPI.get("partBaseInfo_" + data.getPartCode().toLowerCase()), PartBaseInfo.class);
                        ...
                        case "request_detail": {
                            JSONObject proParams = new JSONObject();
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetCKListForLSDHCK", "CKListForZCJHCK", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    CKListForZCJHCK data = (CKListForZCJHCK) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0
                ...
                case "非生产领料报表": {
                    switch (operation) {
                        case "create": {
                            ...
                            json = reportOperate(operateType, "spGetCKListForFJHCK", "CKListForFJHCK", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                        ...
                        case "request_detail": {
                            JSONObject proParams = new JSONObject();
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetCKListForFJHCK", "CKListForFJHCK", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    CKListForFJHCK data = (CKListForFJHCK) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0
                ...
                case "配送上线报表": {
                    switch (operation) {
                        case "create": {
                            ...
                            json = reportOperate(operateType, "spGetCKListForJPSX", "CKListForJPSX", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                        ...
                        case "request_detail": {
                            ...
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetCKListForJPSX", "CKListForJPSX", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    CKListForJPSX data = (CKListForJPSX) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0
                ...
                case "退货出库报表": {
                    switch (operation) {
                        ...
                        case "request_detail": {
                            ...
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetTHListForBPTH", "THListForBPTH", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    THListForBPTH data = (THListForBPTH) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0
                ...
                case "良品库存报表": {
                    switch (operation) {
                        case "create": {
                            ...
                            json = reportOperate(operateType, "spGetKFJCListForLp", "KFJCListForLp", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                            ...
                            if (loginType.compareTo("customerLogin") == 0) {
                                json = reportOperateWithPageForSupplier(userName, operateType, "spGetKFJCListForLpWithFilter", "com.cn.bean.report.", "KFJCListForLp",
                                        "SupplierID", datas, pageSize, pageIndex, null, end, new ReportInterface_backup.ReportItemOperate() {
                                    @Override
                                    public void itemObjOperate(Object obj) {
                                        KFJCListForLp data = (KFJCListForLp) obj;
                                        PartBaseInfo baseInfo = JSONObject.parseObject(RedisAPI.get("partBaseInfo_" + data.getPartCode().toLowerCase()), PartBaseInfo.class);
                        ...
                        case "request_detail": {
                            ...
                            JSONObject proParams = new JSONObject();
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetKFJCListForLp", "KFJCListForLp", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    KFJCListForLp data = (KFJCListForLp) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0
                ...
                case "不良品库存报表": {
                    switch (operation) {
                        case "create": {
                            ...
                            json = reportOperate(operateType, "spGetKFJCListForBLp", "KFJCListForBLp", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                        ...
                        case "request_detail": {
                            ...
                            JSONObject proParams = new JSONObject();
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetKFJCListForBLp", "KFJCListForBLp", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    KFJCListForBLp data = (KFJCListForBLp) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0
                ...
                case "待检库存报表": {
                    switch (operation) {
                        case "create": {
                            ...
                            json = reportOperate(operateType, "spGetKFJCListForDjp", "KFJCListForDjp", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                        ...
                        case "request_detail": {
                            ...
                            JSONObject proParams = new JSONObject();
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetKFJCListForDjp", "KFJCListForDjp", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    KFJCListForDjp data = (KFJCListForDjp) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0
                ...
                case "送检品库存报表": {
                    switch (operation) {
                        case "create": {
                            ...
                            json = reportOperate(operateType, "spGetKFJCListForSjp", "KFJCListForSjp", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                        ...
                        case "request_detail": {
                            ...
                            JSONObject proParams = new JSONObject();
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetKFJCListForSjp", "KFJCListForSjp", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    KFJCListForSjp data = (KFJCListForSjp) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0
                ...
                case "返修品库存报表": {
                    switch (operation) {
                        case "create": {
                            ...
                            json = reportOperate(operateType, "spGetKFJCListForFxp", "KFJCListForFxp", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                        ...
                        case "request_detail": {
                            ...
                            JSONObject proParams = new JSONObject();
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetKFJCListForFxp", "KFJCListForFxp", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    KFJCListForFxp data = (KFJCListForFxp) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0
                ...
                case "库存期初分录": {
                    switch (operation) {
                        case "create": {
                            /*
                            JSONObject proParams = new JSONObject();
                            json = reportOperate(operateType, "spGetKFQCFenLuData", "KFQCFenLuData", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                             ...
                             */
                            if (loginType.compareTo("customerLogin") == 0) {
                                json = reportOperateWithPageForSupplier(userName, operateType, "spGetKFQCFenLuDataWithFilter", "com.cn.bean.report.", "KFQCFenLuData",
                                ...
                                json = reportOperateWithPage(operateType, "spGetKFQCFenLuDataWithFilter", "com.cn.bean.report.", "KFQCFenLuData",
                                        "SupplierID", datas, pageSize, pageIndex, null, null,
                                        new ReportItemOperate() {
                                    @Override
                                    public void itemObjOperate(Object obj) {
                        ...
                        case "request_detail": {
                            ...
                            JSONObject proParams = new JSONObject();
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetKFQCFenLuData", "KFQCFenLuData", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    KFQCFenLuData data = (KFQCFenLuData) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0
                ...
                case "部品退库分录": {
                    switch (operation) {
                        case "create": {
                            /*
                            JSONObject proParams = new JSONObject();
                            json = reportOperate(operateType, "spGetTKFenLuData", "TKFenLuData", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                             ...
                             */
                            if (loginType.compareTo("customerLogin") == 0) {
                                json = reportOperateWithPageForSupplier(userName, operateType, "spGetTKFenLuDataWithFilter", "com.cn.bean.report.", "TKFenLuData",
                                        "SupplierID", datas, pageSize, pageIndex, start, end,
                                        new ReportItemOperate() {
                                    @Override
                                    public void itemObjOperate(Object obj) {
                                ...
                                json = reportOperateWithPage(operateType, "spGetTKFenLuDataWithFilter", "com.cn.bean.report.", "TKFenLuData",
                                        "SupplierID", datas, pageSize, pageIndex, start, end,
                                        new ReportItemOperate() {
                                    @Override
                                    public void itemObjOperate(Object obj) {
                        ...
                        case "request_detail": {
                            ...
                            JSONObject proParams = new JSONObject();
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetTKFenLuData", "TKFenLuData", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    TKFenLuData data = (TKFenLuData) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0
                ...
                case "部品退货分录": {
                    switch (operation) {
                        case "create": {
                            /*
                            JSONObject proParams = new JSONObject();
                            json = reportOperate(operateType, "spGetTHFenLuData", "THFenLuData", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                             ...
                             */
                            if (loginType.compareTo("customerLogin") == 0) {
                                json = reportOperateWithPageForSupplier(userName, operateType, "spGetTHFenLuDataWithFilter", "com.cn.bean.report.", "THFenLuData",
                                        "SupplierID", datas, pageSize, pageIndex, start, end,
                                        new ReportItemOperate() {
                                    @Override
                                    public void itemObjOperate(Object obj) {
                        ...
                        case "request_detail": {
                            json = reportOperateDetailWithPage(operateType, "spGetTHFenLuDataWithFilter", "com.cn.bean.report.", "THFenLuData",
                                    "SupplierID", datas, pageSize, pageIndex, start, end,
                                    new ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                            ...
                            JSONObject proParams = new JSONObject();
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetTHFenLuData", "THFenLuData", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    THFenLuData data = (THFenLuData) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0
                ...
                case "部品出库分录": {
                    switch (operation) {
                        case "create": {
                            ...
                            json = reportOperate(operateType, "spGetCKFenLuData", "CKFenLuData", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                             ...
                             */
                            if (loginType.compareTo("customerLogin") == 0) {
                                json = reportOperateWithPageForSupplier(userName, operateType, "spGetCKFenLuDataWithFilter", "com.cn.bean.report.", "CKFenLuData",
                                        "SupplierID", datas, pageSize, pageIndex, start, end,
                                        new ReportItemOperate() {
                                    @Override
                                    public void itemObjOperate(Object obj) {
                                ...
                                json = reportOperateWithPage(operateType, "spGetCKFenLuDataWithFilter", "com.cn.bean.report.", "CKFenLuData",
                                        "SupplierID", datas, pageSize, pageIndex, start, end,
                                        new ReportItemOperate() {
                                    @Override
                                    public void itemObjOperate(Object obj) {
                        ...
                        case "request_detail": {
                            ...
                            JSONObject proParams = new JSONObject();
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetCKFenLuData", "CKFenLuData", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    CKFenLuData data = (CKFenLuData) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0
                ...
                case "部品入库分录": {
                    switch (operation) {
                        case "create": {
                            ...
                            json = reportOperate(operateType, "spGetRKFenLuData", "RKFenLuData", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                             ...
                             */
                            if (loginType.compareTo("customerLogin") == 0) {
                                json = reportOperateWithPageForSupplier(userName, operateType, "spGetRKFenLuDataWithFilter", "com.cn.bean.report.", "RKFenLuData",
                                        "SupplierID", datas, pageSize, pageIndex, start, end,
                                        new ReportItemOperate() {
                                    @Override
                                    public void itemObjOperate(Object obj) {
                        ...
                        case "request_detail": {
                            json = reportOperateDetailWithPage(operateType, "spGetRKFenLuDataWithFilter", "com.cn.bean.report.", "RKFenLuData",
                                    "SupplierID", datas, pageSize, pageIndex, start, end,
                                    new ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                            ...
                            JSONObject proParams = new JSONObject();
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetRKFenLuData", "RKFenLuData", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    RKFenLuData data = (RKFenLuData) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0
                ...
                case "库房结存分录": {
                    switch (operation) {
                        case "create": {
                            ...
                            json = reportOperate(operateType, "spGetKFJCFenLuData", "KFJCFenLuData", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                        ...
                        case "request_detail": {
                            json = reportOperateDetailWithPage(operateType, "spGetKFJCFenLuDataWithFilter", "com.cn.bean.report.", "KFJCFenLuData",
                                    "SupplierID", datas, pageSize, pageIndex, null, end,
                                    new ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                            ...
                            JSONObject proParams = new JSONObject();
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetKFJCFenLuData", "KFJCFenLuData", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    KFJCFenLuData data = (KFJCFenLuData) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0
                ...
                case "现场期初分录": {
                    switch (operation) {
                        case "create": {
                            ...
                            json = reportOperate(operateType, "spGetXCQCFenLuData", "XCQCFenLuData", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                             ...
                             */
                            if (loginType.compareTo("customerLogin") == 0) {
                                json = reportOperateWithPageForSupplier(userName, operateType, "spGetXCQCFenLuDataWithFilter", "com.cn.bean.report.", "XCQCFenLuData",
                                        "SupplierID", datas, pageSize, pageIndex, start, end,
                                        new ReportItemOperate() {
                                    @Override
                                    public void itemObjOperate(Object obj) {
                        ...
                        case "request_detail": {
                            json = reportOperateDetailWithPage(operateType, "spGetXCQCFenLuDataWithFilter", "com.cn.bean.report.", "XCQCFenLuData",
                                    "SupplierID", datas, pageSize, pageIndex, start, end,
                                    new ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                            ...
                            JSONObject proParams = new JSONObject();
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetXCQCFenLuData", "XCQCFenLuData", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    XCQCFenLuData data = (XCQCFenLuData) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0
                ...
                case "现场结存分录": {
                    switch (operation) {
                        case "create": {
                            ...
                            json = reportOperate(operateType, "spGetXCJCFenLuData", "XCJCFenLuData", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                             ...
                             */
                            if (loginType.compareTo("customerLogin") == 0) {
                                json = reportOperateWithPageForSupplier(userName, operateType, "spGetXCJCFenLuDataWithFilter", "com.cn.bean.report.", "XCJCFenLuData",
                                        "SupplierID", datas, pageSize, pageIndex, start, end,
                                        new ReportItemOperate() {
                                    @Override
                                    public void itemObjOperate(Object obj) {
                        ...
                        case "request_detail": {
                            json = reportOperateDetailWithPage(operateType, "spGetXCJCFenLuDataWithFilter", "com.cn.bean.report.", "XCJCFenLuData",
                                    "SupplierID", datas, pageSize, pageIndex, start, end,
                                    new ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                            ...
                            JSONObject proParams = new JSONObject();
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetXCJCFenLuData", "XCJCFenLuData", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    XCJCFenLuData data = (XCJCFenLuData) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0
                ...
                case "库房盈亏分录": {
                    switch (operation) {
                        case "create": {
                            ...
                            json = reportOperate(operateType, "spGetKFTZFenLuData", "KFTZFenLuData", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                             ...
                             */
                            if (loginType.compareTo("customerLogin") == 0) {
                                json = reportOperateWithPageForSupplier(userName, operateType, "spGetKFTZFenLuDataWithFilter", "com.cn.bean.report.", "KFTZFenLuData",
                                        "SupplierID", datas, pageSize, pageIndex, start, end,
                                        new ReportItemOperate() {
                                    @Override
                                    public void itemObjOperate(Object obj) {
                        ...
                        case "request_detail": {
                            json = reportOperateDetailWithPage(operateType, "spGetKFTZFenLuDataWithFilter", "com.cn.bean.report.", "KFTZFenLuData",
                                    "SupplierID", datas, pageSize, pageIndex, start, end,
                                    new ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                            ...
                            JSONObject proParams = new JSONObject();
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetKFTZFenLuData", "KFTZFenLuData", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    KFTZFenLuData data = (KFTZFenLuData) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0
                ...
                case "现场盈亏分录": {
                    switch (operation) {
                        case "create": {
                            ...
                            json = reportOperate(operateType, "spGetXCTZFenLuData", "XCTZFenLuData", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                             ...
                             */
                            if (loginType.compareTo("customerLogin") == 0) {
                                json = reportOperateWithPageForSupplier(userName, operateType, "spGetXCTZFenLuDataWithFilter", "com.cn.bean.report.", "XCTZFenLuData",
                                        "SupplierID", datas, pageSize, pageIndex, start, end,
                                        new ReportItemOperate() {
                                    @Override
                                    public void itemObjOperate(Object obj) {
                        ...
                        case "request_detail": {
                            json = reportOperateDetailWithPage(operateType, "spGetXCTZFenLuDataWithFilter", "com.cn.bean.report.", "XCTZFenLuData",
                                    "SupplierID", datas, pageSize, pageIndex, start, end,
                                    new ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                            ...
                            JSONObject proParams = new JSONObject();
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "spGetXCTZFenLuData", "XCTZFenLuData", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    XCTZFenLuData data = (XCTZFenLuData) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0
                ...
                case "盛具报表": {
                    switch (operation) {
                        case "create": {
                            ...
                            json = reportOperate(operateType, "tbGetContainerAmount", "ContainerAmount", proParams, new ReportInterface_backup.ReportItemOperate() {
                                @Override
                                public void itemObjOperate(Object obj) {
                             ...
                             */
                            if (loginType.compareTo("customerLogin") == 0) {
                                json = reportOperateWithPageForSupplier(userName, operateType, "tbGetContainerAmountWithFilter", "com.cn.bean.report.", "ContainerAmount",
                                        "SupplierID", datas, pageSize, pageIndex, start, end,
                                        new ReportItemOperate() {
                                    @Override
                                    public void itemObjOperate(Object obj) {
                                ...
                                json = reportOperateWithPage(operateType, "tbGetContainerAmountWithFilter", "com.cn.bean.report.", "ContainerAmount",
                                        "SupplierID", datas, pageSize, pageIndex, start, end,
                                        new ReportItemOperate() {
                                    @Override
                                    public void itemObjOperate(Object obj) {
                        ...
                        case "request_detail": {
                            JSONObject proParams = new JSONObject();
                            JSONObject dataJson = JSONObject.parseObject(datas);
                            json = reportOperateWithFilter(operateType, "tbGetContainerAmount", "ContainerAmount", proParams, new ReportInterface_backup.FilterListItemOperate() {
                                @Override
                                public void itemFilter(List<Object> filterList, Object obj) {
                                    ContainerAmount data = (ContainerAmount) obj;
                                    if (data.getSupplierID().compareToIgnoreCase(dataJson.getString("supplierID")) == 0) {
    ...
    private String reportOperateWithPage(String operateType, String proceduceName, String packageName, String className, String orderField,
