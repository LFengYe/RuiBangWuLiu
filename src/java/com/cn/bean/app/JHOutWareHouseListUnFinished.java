 ...
 * @author LFeng
 */
public class JHOutWareHouseListUnFinished implements Comparable{
    ...
    private int unFinishPacking;
    
    @Override
    public int compareTo(Object o) {
        JHOutWareHouseListUnFinished list = (JHOutWareHouseListUnFinished) o;
    ...
    public int getUnFinishAmount() {
        return unFinishAmount;
    }

    public void setUnFinishAmount(int unFinishAmount) {
        this.unFinishAmount = unFinishAmount;
    }

    public int getUnFinishPacking() {
        return unFinishPacking;
    }

    public void setUnFinishPacking(int unFinishPacking) {
        this.unFinishPacking = unFinishPacking;
    }
}
