...
public class KFJCListForSjp {
    ...
    @FieldDescription(description = "送检品数量")
    private String kcSjpAmount;
    ...
    public String getKcSjpAmount() {
        return kcSjpAmount;
    }

    public void setKcSjpAmount(String kcSjpAmount) {
        this.kcSjpAmount = kcSjpAmount;
    }
