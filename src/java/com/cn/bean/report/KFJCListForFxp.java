...
public class KFJCListForFxp {
    ...
    public String getKcFxpAmount() {
        return kcFxpAmount;
    }

    public void setKcFxpAmount(String kcFxpAmount) {
        this.kcFxpAmount = kcFxpAmount;
    }
