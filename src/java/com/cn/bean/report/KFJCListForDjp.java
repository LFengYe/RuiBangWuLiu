...
public class KFJCListForDjp {
    ...
    @FieldDescription(description = "待检品数量")
    private String kcDjpAmount;
    ...
    public String getKcDjpAmount() {
        return kcDjpAmount;
    }

    public void setKcDjpAmount(String kcDjpAmount) {
        this.kcDjpAmount = kcDjpAmount;
    }
