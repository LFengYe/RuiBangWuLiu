...
public class KFJCBLPForBPTH {
    ...
    public String getKfJCBLpAmount() {
        return kfJCBLpAmount;
    }

    public void setKfJCBLpAmount(String kfJCBLpAmount) {
        this.kfJCBLpAmount = kfJCBLpAmount;
    }
