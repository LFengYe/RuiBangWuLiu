...
public class KFJCFXPForBPTH {
    ...
    public String getKfJCFXpAmount() {
        return kfJCFXpAmount;
    }

    public void setKfJCFXpAmount(String kfJCFXpAmount) {
        this.kfJCFXpAmount = kfJCFXpAmount;
    }
