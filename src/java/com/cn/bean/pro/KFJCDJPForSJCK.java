...
public class KFJCDJPForSJCK {
    ...
    public String getKfJCDjpAmount() {
        return kfJCDjpAmount;
    }

    public void setKfJCDjpAmount(String kfJCDjpAmount) {
        this.kfJCDjpAmount = kfJCDjpAmount;
    }
