...
public class KFJCSJPForSJTK {
    ...
    public String getKfJCSjpAmount() {
        return kfJCSjpAmount;
    }

    public void setKfJCSjpAmount(String kfJCSjpAmount) {
        this.kfJCSjpAmount = kfJCSjpAmount;
    }
