...
public class KFJCDJPForBPTH {
    ...
    public String getKfDjpJCAmount() {
        return kfDjpJCAmount;
    }

    public void setKfDjpJCAmount(String kfDjpJCAmount) {
        this.kfDjpJCAmount = kfDjpJCAmount;
    }
