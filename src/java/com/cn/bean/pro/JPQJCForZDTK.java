...
public class JPQJCForZDTK {
    ...
    public String getJpqJCAmount() {
        return jpqJCAmount;
    }

    public void setJpqJCAmount(String jpqJCAmount) {
        this.jpqJCAmount = jpqJCAmount;
    }
