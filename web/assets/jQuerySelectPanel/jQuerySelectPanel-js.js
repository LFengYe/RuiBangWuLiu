			...
			SelectPanel.prototype.reset = function(data,fun){  	//public
				this.data = data;
				this.callback = fun;
				this.render();
				this.bindClickEvt();
			}
			SelectPanel.prototype.show = function(){              //public
				this.$container.show(500);
			}
			SelectPanel.prototype.initDOM = function(){        //private
				this.$container = $('<div class = "SelectPanel"></div>');
			    this.$container.appendTo("body");
			}
            SelectPanel.prototype.render = function(){        //private
