...
$.fn.insertMenuPlug = function(options){
   ...
   var iconArr = ["glyphicon glyphicon-plus-sign","glyphicon glyphicon-header","glyphicon glyphicon-paperclip","glyphicon glyphicon-new-window","glyphicon glyphicon-fire","glyphicon glyphicon-calendar","glyphicon glyphicon-eye-open","glyphicon glyphicon-screenshot","glyphicon glyphicon-info-sign","glyphicon glyphicon-align-left"];	
	var index = 0;
